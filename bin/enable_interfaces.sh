...
show_menu() {
    ...
    echo "|  2 |  [$(if grep -q "i2c1" "$ARMBIAN_ENV"; then echo "X"; else echo " "; fi)]   | I2C1 (SDA: ${COLOR_I2C}GPIOA19${COLOR_RESET}[${COLOR_VDD}27${COLOR_RESET}], SCL: ${COLOR_I2C}GPIOA18${COLOR_RESET}[${COLOR_VDD}28${COLOR_RESET}])         |"
    echo "|  3 |  [$(if grep -q "i2c2" "$ARMBIAN_ENV"; then echo "X"; else echo " "; fi)]   | I2C2 (SDA: ${COLOR_I2C}GPIOA12${COLOR_RESET}[${COLOR_VDD}3${COLOR_RESET}], SCL: ${COLOR_I2C}GPIOA11${COLOR_RESET}[${COLOR_VDD}4${COLOR_RESET}])           |"
    echo "|  4 |  [$(if grep -q "uart1" "$ARMBIAN_ENV"; then echo "X"; else echo " "; fi)]   | UART1 (TX: ${COLOR_UART}GPIOG6${COLOR_RESET}[${COLOR_VDD}8${COLOR_RESET}], RX: ${COLOR_UART}GPIOG7${COLOR_RESET}[${COLOR_VDD}10${COLOR_RESET}])             |"
    echo "|  5 |  [$(if grep -q "uart2" "$ARMBIAN_ENV"; then echo "X"; else echo " "; fi)]   | UART2 (TX: ${COLOR_UART}GPIOA0${COLOR_RESET}[${COLOR_VDD}11${COLOR_RESET}], RX: ${COLOR_UART}GPIOA1${COLOR_RESET}[${COLOR_VDD}22${COLOR_RESET}])            |"
    echo "|  6 |  [$(if grep -q "uart3" "$ARMBIAN_ENV"; then echo "X"; else echo " "; fi)]   | UART3 (TX: ${COLOR_UART}GPIOA16${COLOR_RESET}[${COLOR_VDD}35${COLOR_RESET}], RX: ${COLOR_UART}GPIOA14${COLOR_RESET}[${COLOR_VDD}40${COLOR_RESET}])          |"
    echo "|  7 |  [$(if grep -q "spi0" "$ARMBIAN_ENV"; then echo "X"; else echo " "; fi)]   | SPI0 (MOSI: ${COLOR_GPIO}GPIOC0${COLOR_RESET}[${COLOR_VDD}19${COLOR_RESET}], MISO: ${COLOR_GPIO}GPIOC1${COLOR_RESET}[${COLOR_VDD}21${COLOR_RESET}])         |"
    echo "-------------------------------------------------------------------"
